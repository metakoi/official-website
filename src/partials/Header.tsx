        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <div className="block"  aria-label="Cruip">
              ...
              <svg className='w-28 lg:w-40 fill-current text-green-200' viewBox="0 0 307 65" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-nowarp md:hidden">
            ...
            <button
              ref={trigger}
              className={` my-2 hamburger w-6 h-6 ${mobileNavOpen && "active"}`}
            ...
            >
              ...
              <svg
                className="w-6 h-6 fill-current text-green-200 hover:text-green-300 transition duration-150 ease-in-out"
                viewBox="0 0 24 24"
