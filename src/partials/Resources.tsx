      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-uncut-sans font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-emerald-400 to-fuchsia-400">欢迎您的来访</h2>
          </div>
          {/* Content */}
          <div>
            {/* Category buttons */}
            <div className="mb-16 hidden">
              <div className="flex flex-wrap justify-center -m-2.5">
                <div className={`${category === '1' && 'rotate-2'}`}>
                  <button className={`w-44 h-10 relative font-medium px-3 py-1.5 bg-gray-800  rounded-full  inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:rounded-full ${category === '1' ? 'shadow-lg shadow-blue-500/25 before:via-gray-300': 'before:via-gray-600'}`} onClick={() => setCategory('1')}>
                    <div className="flex items-center justify-center">
                      ...
                      <span className={`transition duration-150 ease-in-out ${category === '1' ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-300'}`}>对于开发人员</span>
                    </div>
                  </button>
                </div>
                <div className={`${category === '2' && 'rotate-2'}`}>
                  <button className={`w-44 h-10 relative font-medium px-3 py-1.5 bg-gray-800 rounded-full inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:rounded-full ${category === '2' ? 'shadow-lg shadow-blue-500/25 before:via-gray-300': 'before:via-gray-600'}`} onClick={() => setCategory('2')}>
                    <div className="flex items-center justify-center">
                      ...
                      <span className={`transition duration-150 ease-in-out ${category === '2' ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-300'}`}>对于设计师</span>
                    </div>
                  </button>
                </div>
                <div className={`${category === '3' && 'rotate-2'}`}>
                  <button className={`w-44 h-10 relative font-medium px-3 py-1.5 bg-gray-800 rounded-full inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:rounded-full ${category === '3' ? 'shadow-lg shadow-blue-500/25 before:via-gray-300': 'before:via-gray-600'}`} onClick={() => setCategory('3')}>
                    <div className="flex items-center justify-center">
                      ...
                      <span className={`transition duration-150 ease-in-out ${category === '3' ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-300'}`}>对于创始人</span>
                    </div>
                  </button>
                </div>
                <div className={`${category === '4' && 'rotate-2'}`}>
                  <button className={`w-44 h-10 relative font-medium px-3 py-1.5 bg-gray-800 rounded-full inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:rounded-full ${category === '4' ? 'shadow-lg shadow-blue-500/25 before:via-gray-300': 'before:via-gray-600'}`} onClick={() => setCategory('4')}>
                    <div className="flex items-center justify-center">
                      ...
                      <span className={`transition duration-150 ease-in-out ${category === '4' ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-300'}`}>对于营销人员</span>
                    </div>
                  </button>
                </div>
              </div>
            ...
            <div className="max-w-sm mx-auto sm:max-w-none grid gap-12 sm:grid-cols-2 md:grid-cols-4 sm:gap-x-6 sm:gap-y-8 items-start">
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Telegram</div>
              </a>
              {/* 2nd Box */}
              <a
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Discord</div>
              </a>
              {/* 3rd Box */}
              <a
                className={`block relative before:content-[''] before:bg-gray-800 before:absolute before:-z-10 before:inset-0 p-6 group ${!['1','2', '3', '4'].includes(category) && 'hidden'}`}
                href="#0"
              >
                <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Medium</div>
              </a>
              {/* 4th Box */}
              <a
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">GitHub</div>
              </a>
              {/* 5th Box */}
              <a
              ...
              >
                ...
                <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Docs</div>
              </a>
              {/* 6th Box */}
              <a
                className={`block relative before:content-[''] before:bg-gray-800 before:absolute before:-z-10 before:inset-0 p-6 group ${![ '2', '4'].includes(category) && 'hidden'}`}
                href="#0"
              >
                <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
