      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div>
            ...
            {/* Boxes */}
            <div className="max-w-sm mx-auto sm:max-w-none flex justify-around  items-start">
              {/* 1st Box */}
              <a
                className={`group`}
                href="#0"
              >
                <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                  <svg className="fill-gray-200 group-hover:fill-blue-500 transition duration-150 ease-in-out" width="26" height="18" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="font-uncut-sans text-xl text-gray-200 group-hover:text-blue-500  font-semibold">Telegram</div>
              </a>
              {/* 2nd Box */}
              <a
                className={`group`}
              ...
              >
                <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                  <svg className="fill-gray-200 group-hover:fill-blue-500 transition duration-150 ease-in-out" width="24" height="18" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="font-uncut-sans text-xl text-gray-200 group-hover:text-blue-500  font-semibold">Discord</div>
              </a>
              {/* 3rd Box */}
              <a
                className={`group`}
              ...
              >
                <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                  <svg className="fill-gray-200 group-hover:fill-blue-500 transition duration-150 ease-in-out" width="22" height="22" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="font-uncut-sans text-xl text-gray-200 group-hover:text-blue-500  font-semibold">Medium</div>
              </a>
              {/* 4th Box */}
              <a
                className={`group`}
              ...
              >
                <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                  <svg className="fill-gray-200 group-hover:fill-blue-500 transition duration-150 ease-in-out" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="font-uncut-sans text-xl text-gray-200 group-hover:text-blue-500 font-semibold">GitHub</div>
              </a>
