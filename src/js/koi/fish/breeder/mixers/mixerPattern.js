...
import MixerLayerBase from "./layers/mixerLayerBase";
import MixerLayerRidge from "./layers/mixerLayerRidge";
import MixerLayerShapeBody from "./layers/mixerLayerShapeBody";
import MixerLayerShapeFin from "./layers/mixerLayerShapeFin";
import MixerLayerSpots from "./layers/mixerLayerSpots";
import MixerLayerStripes from "./layers/mixerLayerStripes";
import MixerLayerWeb from "./layers/mixerLayerWeb";
...
MixerPattern.prototype.mix = function(
    ...
    if (this.patternsEqual(this.mother, this.father)) {
        console.log("this.patternsEqual = ",true)
        ...
        console.log("this.patternsEqual = ",false)
        // TODO: Dominance?
