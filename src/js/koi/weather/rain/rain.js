...
Rain.prototype.DROP_LENGTH = window.renderSnow ? .05 : .6;
Rain.prototype.DROP_DISTANCE = window.renderSnow ? 6 : 10;
Rain.prototype.DROP_FALL_PORTION = 1 - Rain.prototype.DROP_LENGTH / Rain.prototype.DROP_DISTANCE;
Rain.prototype.DROP_ALPHA = .7;
Rain.prototype.DROP_ANGLE = window.renderSnow ? Math.PI * .5 : Math.PI * .55;
Rain.prototype.DROP_ANGLE_RADIUS = window.renderSnow ? Math.PI * .2 : Math.PI * 0.015;
Rain.prototype.DROP_ANGLE_SAMPLER = window.renderSnow ?
    new Sampler(
...
Rain.prototype.CELL = window.renderSnow ? .1 : .3;
