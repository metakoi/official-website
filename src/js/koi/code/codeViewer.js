...
CodeViewer.prototype.createButtonCopy = function(image, audio) {
    ...
    button.appendChild(document.createTextNode(window.language.get(this.LANG_COPY)));
    button.onclick = () => {
...
CodeViewer.prototype.createButtonDownload = function(image, audio) {
    ...
    button.appendChild(document.createTextNode(window.language.get(this.LANG_SAVE)));
    button.onclick = () => {
        audio.effectClick.play();
...
CodeViewer.prototype.createHelpText = function() {
    ...
    text.appendChild(document.createTextNode(window.language.get(this.LANG_HELP)));
