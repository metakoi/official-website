...
TutorialCards.prototype.start = function() {
    this.overlay.setText(window.language.get(this.LANG_CREATE_CARD));
    ...
    switch (this.phase) {
        ...
        case this.PHASE_CREATE_CARD:
            if (koi.gui.cards.hand.cards.length > 0) {
                this.overlay.setText(window.language.get(this.LANG_OPEN_BOOK_STORE));
        ...
        case this.PHASE_OPEN_BOOK:
            if (!this.stored && koi.gui.cards.hand.cards.length === 0 && !koi.gui.cards.grabbed) {
                ...
                if (this.stored) {
                    this.overlay.setText(window.language.get(this.LANG_UNLOCK));
                    ...
                    this.overlay.deleteArrow();
                    this.overlay.setText(window.language.get(this.LANG_STORE_CARD));
