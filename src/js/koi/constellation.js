...
import ConstraintCircle from "./constraint/constraintCircle";
import ConstraintArcPath from "./constraint/constraintArcPath";
...
Constellation.prototype.fit = function(atlas = null) {
    const radiusBigMax = Math.min(this.width, this.height);
    ...
    const centerBig = new Vector2(this.width/2, this.height/2);
...
Constellation.prototype.update = function(
    ...
    raining,
    random) {
    this.big.update(atlas, patterns, randomSource, mutations, forceMutation, water, audio, this, raining, random);
};
