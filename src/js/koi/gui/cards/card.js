...
Card.prototype.initialize = function(
    ...
    const requirement = window.loader.hasFinished() ? null : window.loader.createRequirement(this.REQUIREMENT_WEIGHT);
...
Card.prototype.createInfo = function() {
    ...
    element.appendChild(this.createProperty(
       window.language.get(this.LANG_WEIGHT),
        this.body.getWeight().toFixed(2) + " " +window.language.get(this.LANG_UNIT_WEIGHT)));
    element.appendChild(this.createProperty(
       window.language.get(this.LANG_LENGTH),
        (this.body.getLength()).toFixed(1).toString() + " " +window.language.get(this.LANG_UNIT_LENGTH)));

    if (window.chosenLocale === "ja" || window.chosenLocale === "zh")
        element.classList.add(this.CLASS_JAPANESE);

    if (ageMinutes < 1)
        element.appendChild(this.createProperty(
           window.language.get(this.LANG_AGE),
           window.language.get(this.LANG_FRY)));
    else if (ageMinutes > 60)
        element.appendChild(this.createProperty(
           window.language.get(this.LANG_AGE),
            "> 60 " +window.language.get(this.LANG_UNIT_TIME)));
    else
        element.appendChild(this.createProperty(
           window.language.get(this.LANG_AGE),
            Math.round(ageMinutes).toString() + " " +window.language.get(this.LANG_UNIT_TIME)));
