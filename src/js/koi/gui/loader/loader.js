...
import LoaderDiscord from "./loaderDiscord";
import LoaderFullscreen from "./loaderFullscreen";
import LoaderIcon from "./loaderIcon";
import LoaderSlot from "./loaderSlot";
...
Loader.prototype.createButtonSettings = function() {
    ...
    element.innerText =window.language.get(this.LANG_SETTINGS);
    element.onclick = () => {
        this.menu.show();
    };
