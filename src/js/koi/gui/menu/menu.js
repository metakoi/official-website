...
Menu.prototype.KEY_LANGUAGE = "window.language";
...
Menu.prototype.createTitle = function() {
    ...
    element.appendChild(document.createTextNode(window.language.get(this.LANG_TITLE)));
...
Menu.prototype.createVolumeSlider = function(audioEngine) {
    ...
    label.appendChild(document.createTextNode(window.language.get(this.LANG_VOLUME)));
...
Menu.prototype.createGrassAudioToggle = function(audioEngine) {
    ...
    label.appendChild(document.createTextNode(window.language.get(this.LANG_GRASS_AUDIO)));
...
Menu.prototype.createFlashToggle = function(externalSettings) {
    ...
    label.appendChild(document.createTextNode(window.language.get(this.LANG_FLASHES)));
    label.appendChild(element);
...
/**
 * Create a window.language chooser
 * @param {String} locale The locale string
 * @returns {HTMLTableRowElement} The table row
 */
Menu.prototype.createLanguageChooser = function(locale) {
    ...
    label.appendChild(document.createTextNode(window.language.get(this.LANG_LANGUAGE)));
...
Menu.prototype.createButtonFullscreen = function(fullscreen, audio) {
    ...
    element.appendChild(document.createTextNode(window.language.get(this.LANG_FULLSCREEN)));
    element.onclick = () => {
        fullscreen.toggle();
...
Menu.prototype.createButtonMenu = function() {
    ...
    element.appendChild(document.createTextNode(window.language.get(this.LANG_MENU)));
    element.onclick = () => {
        window.reloadMenu();
    };
...
Menu.prototype.createButtonQuit = function() {
    if (window["require"]) {
        ...
        element.appendChild(document.createTextNode(window.language.get(this.LANG_QUIT)));
        element.onclick = () => {
            w["close"]();
        };
...
Menu.prototype.createButtonExit = function(audio) {
    ...
    element.appendChild(document.createTextNode(window.language.get(this.LANG_EXIT)));
    element.onclick = () => {
        this.hide();
