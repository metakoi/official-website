...
import BlueprintBody from "../blueprint/blueprintBody";
import BlueprintFin from "../blueprint/blueprintFin";
import BlueprintFins from "../blueprint/blueprintFins";
import BlueprintPattern from "../blueprint/blueprintPattern";
import BlueprintTail from "../blueprint/blueprintTail";
import BlueprintLayerBase from "../blueprint/layers/blueprintLayerBase";
import BlueprintLayerShapeBody from "../blueprint/layers/blueprintLayerShapeBody";
import BlueprintLayerShapeFin from "../blueprint/layers/blueprintLayerShapeFin";
import Koi from "../koi";
...
SpawnerState.prototype.BLUEPRINTS = [
    ...
    new Blueprint(
        ...
        new BlueprintBody(
            ...
            new BlueprintPattern(
                // Base
                new BlueprintLayerBase(Palette.INDEX_PURPLE),
                // Body shape
                new BlueprintLayerShapeBody(
                    // Center power
                    new Sampler(50, 100),
    ...
    new Blueprint(
        ...
        new BlueprintBody(
            ...
            new BlueprintPattern(
                // Base
                new BlueprintLayerBase(Palette.INDEX_BLUE),
                // Body shape
                new BlueprintLayerShapeBody(
                    // Center power
                    new Sampler(50, 100),
    ...
    if (++this.time === this.CHECK_FREQUENCY) {
        ...
        if (this.school !== 0) {
            if (constellation.getFishCount() + overhead < Koi.prototype.FISH_CAPACITY){
                ...
                let position = new Vector2(0,Math.floor(Math.random() * constellation.big.constraint.height))
                constellation.big.addFish(this.spawning.spawn(
            ...
            if (this.spawning && constellation.big.getFishCount() < limit)
                this.school = behavior.getSchoolSize(this.spawning, random);
        }
    }
};

export default SpawnerState