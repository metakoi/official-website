import LayerBase from "../koi/fish/pattern/layer/layerBase";
import LayerRidge from "../koi/fish/pattern/layer/layerRidge";
import LayerShapeBody from "../koi/fish/pattern/layer/layerShapeBody";
import LayerShapeFin from "../koi/fish/pattern/layer/layerShapeFin";
import LayerSpots from "../koi/fish/pattern/layer/layerSpots";
import LayerStripes from "../koi/fish/pattern/layer/layerStripes";
import LayerWeb from "../koi/fish/pattern/layer/layerWeb";
import Palette from "../koi/samplers/palette";
...
const Patterns = function(gl) {
    ...
    this.programWeb = LayerWeb.prototype.createShader(gl);
    this.vaoWeb = this.createVAO(gl, this.programWeb);
    ...
    for (const layer of pattern.layers) {
        ...
        switch (layer.id) {
            ...
            case LayerWeb.prototype.ID:
                this.writeLayer(layer, this.programWeb, this.vaoWeb, color);
...
Patterns.prototype.free = function() {
    ...
    this.programWeb.free();
    this.gl.vao.deleteVertexArrayOES(this.vaoWeb);
