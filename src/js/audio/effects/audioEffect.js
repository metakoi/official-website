...
const AudioEffect = function(engine, sources) {
    ...
    if (this.singleSource) {
        const requirement1 = window.loader.createRequirement(this.REQUIREMENT_WEIGHT);
        const requirement2 = window.loader.createRequirement(this.REQUIREMENT_WEIGHT);
        ...
        const requirement = window.loader.createRequirement(this.REQUIREMENT_WEIGHT);
