        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="shrink-0 mr-4">
              {/* Logo */}
              <Link className="block" to="/official-website/" aria-label="Cruip">
                ...
                <div className="py-16 md:py-20">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <div className="flex justify-between">
                          ...
                          <Link className="text-sm font-medium text-blue-500 hover:text-blue-400 ml-2" to="/official-website/reset-password">Troubles?</Link>
                        </div>
                  ...
                  <div className="mt-6">
                    <div className="text-sm text-gray-400">
                      Don't you have an account? <Link className="font-medium text-blue-500 hover:text-blue-400" to="/official-website/signup">Sign Up</Link>
                    </div>
                  </div>
                </div>
              </div>
